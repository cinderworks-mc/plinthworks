...
public class ModLangProvider extends LanguageProvider
{
	...
	protected void addTranslations() {
		...
		add("gui.plinthworks.verb", "Verb: %s");
		add("gui.plinthworks.interval", "Every %s ticks");
		add("gui.plinthworks.throughput", "Move %s/op");
		add("gui.plinthworks.storage", "Holds %s stacks");
		add("gui.plinthworks.range", "Reach %s");
		add("gui.plinthworks.configure_seal", "Edit");
		...
		add("gui.plinthworks.network", "%s - %s members - %s");
