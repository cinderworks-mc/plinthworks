package dev.hartforge.plinthworks.block.entity;
...
import dev.hartforge.plinthworks.logic.seal.SealMatch.SealEntry;
...
public class PlinthBlockEntity extends BlockEntity
{
	...
	public int channelMembers() {
		...
		return dev.hartforge.plinthworks.logic.network.PlinthNetwork.get(serverLevel)
